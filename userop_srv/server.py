...
from userop_srv.handler.address.address import AddressServicer
from userop_srv.handler.message.message import MessageServicer
from userop_srv.handler.userfav.userfav import UserFavServicer

BASE_URL = os.path.dirname(os.path.abspath(os.path.dirname(__file__)))
print(BASE_URL)
sys.path.insert(0, BASE_URL)
from userop_srv.proto import address_pb2,address_pb2_grpc,message_pb2,message_pb2_grpc,userfav_pb2,userfav_pb2_grpc
